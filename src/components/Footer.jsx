        ...
        <footer className="bg-[#2B5659] w-full h-40 flex items-center justify-evenly">
            ...
            <div className="footer-info h-18">
                <div className='flex h-1/3 w-auto mb-5'>
                    <img src="/images/envelope_1.svg" className="mx-2" />
                    <p className='px-2'>s111234567@stu.ntue.edu.tw</p>
                </div>
                <div className='flex h-1/3 w-auto '>
                    <img src="/images/mail_1.svg" className="mx-2" />
            ...
            <div className="footer-icons flex">
                <img src="/images/fb_1.svg" className="mx-2" />
                <img src="/images/ig_1.svg" className="mx-2" />
                <img src="/images/x_1.svg" className="mx-2" />
                <img src="/images/yt_1.svg" className="mx-2" />
            </div>
        </footer>
    );
};
